...
public class Revert extends Contract {
    ...
    protected Revert(final String contractAddress, final Web3j web3j, final Credentials credentials, final ContractGasProvider contractGasProvider, final TransactionReceipt transactionReceipt) {
        super(BINARY, contractAddress, web3j, credentials, contractGasProvider, transactionReceipt);
    }

    protected Revert(final String contractAddress, final Web3j web3j, final TransactionManager transactionManager, final ContractGasProvider contractGasProvider, final TransactionReceipt transactionReceipt) {
        super(BINARY, contractAddress, web3j, transactionManager, contractGasProvider, transactionReceipt);
    }

    public RemoteTransactionCall<Void> set(final BigInteger _number) {
    ...
    public static Revert load(final String contractAddress, final Web3j web3j, final Credentials credentials, final ContractGasProvider contractGasProvider) {
        return new Revert(contractAddress, web3j, credentials, contractGasProvider, null);
    }
    ...
    public static Revert load(final String contractAddress, final Web3j web3j, final TransactionManager transactionManager, final ContractGasProvider contractGasProvider) {
        return new Revert(contractAddress, web3j, transactionManager, contractGasProvider, null);
    }

    public static RemoteTransaction<Revert> deploy(final Web3j web3j, final Credentials credentials, final ContractGasProvider contractGasProvider) {
        return deployRemoteCall(Revert.class, web3j, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteTransaction<Revert> deploy(final Web3j web3j, final TransactionManager transactionManager, final ContractGasProvider contractGasProvider) {
